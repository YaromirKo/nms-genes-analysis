---
title: "Analysis of genes with bootstrap and permutation (RD) Net Sh with median"
...
rds_file <- file.path(main_dir, path_rds, paste0(
  "all_groups_boot_", formatter(R), "_", my.cores, "_cores_", DESIGN, "_Net_Sh_median.rds"
))
...
groups_results <- paste0("./data/Net_Sh_median_groups_result_", format(Sys.time(), '%d_%m_%Y'), ".xlsx")
...
myname <- "corr_groups_Net_Sh_median_"
